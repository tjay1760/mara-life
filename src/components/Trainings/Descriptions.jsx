...
const Descriptions = () => {
  return (
    <div className="w-11/12 mx-auto mt-10 p-2 md:grid md:grid-cols-2 md:gap-5">
        <div className="descriptions flex flex-col gap-2">
            ...
            <button className='bg-gray-300 py-1 px-2 rounded-lg md:max-w-fit'>Register Now</button>
            <div className="companies flex border p-2 gap-2 rounded-lg text-xs md:text-sm md:justify-between md:mt-20">
