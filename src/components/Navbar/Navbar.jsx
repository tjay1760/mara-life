  ...
  return (
    <>
      ...
      <button
        ...
        } text-3xl text-gray-600 lg:hidden fixed top-4 right-2 z-50`}
      ...
      <div
        ...
        } flex-col fixed items-center border z-50 bg-white rounded-2xl h-96 m-3 gap-3 w-11/12 lg:h-auto lg:w-[60%] lg:right-1 lg:rounded-xl lg:justify-between lg:fixed lg:border-4 lg:border-opacity-5`}
        style={{
